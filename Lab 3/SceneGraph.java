...
public class SceneGraph extends JPanel {
	...
	private void createWorld() {
		...
		Triangle_2.setScale(0.5, 1).setTranslation(-2.25, 0.5).setColor(Color.MAGENTA.darker());
		Triangle_3.setScale(0.5, 0.8).setTranslation(1.5, 1).setColor(Color.GREEN.darker());
